...
function eventKrpanoLoaded (isWebVr) {
	...
	ktools.I18N.getInstance().initLanguage(tourLanguage, crossDomainTargetUrl+'Visite virtuelle college notre dame de la paixdata/Visite virtuelle college notre dame de la paix_messages_','.xml');
	krpanoLoaded = true;
...
function eventTourChangeLanguage (pLang) {
	...
	ktools.I18N.getInstance().initLanguage(pLang, crossDomainTargetUrl+'Visite virtuelle college notre dame de la paixdata/Visite virtuelle college notre dame de la paix_messages_','.xml');
}
...
function addKolorMenu(pPlugID) 
{
	...
	{
		var kolorMenuCSS = new ktools.CssStyle("KolorMenuCSS", crossDomainTargetUrl+"Visite virtuelle college notre dame de la paixdata/graphics/KolorMenu/kolorMenu.css");
		var kolorMenuJS = new ktools.Script("KolorMenuJS", crossDomainTargetUrl+"Visite virtuelle college notre dame de la paixdata/graphics/KolorMenu/KolorMenu.min.js", [], true);
