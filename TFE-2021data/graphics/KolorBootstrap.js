...
function eventKrpanoLoaded (isWebVr) {
	...
	ktools.I18N.getInstance().initLanguage(tourLanguage, crossDomainTargetUrl+'TFE-2021data/TFE-2021_messages_','.xml');
	krpanoLoaded = true;
	...
	addKolorBox('gallery35');
addKolorBox('gallery34');
addKolorBox('gallery33');
addKolorBox('gallery32');
addKolorBox('gallery31');
addKolorBox('gallery30');
addKolorBox('gallery29');
addKolorBox('gallery28');
addKolorBox('gallery27');
addKolorBox('gallery26');
...
deleteKolorBox('gallery26');
deleteKolorBox('gallery27');
deleteKolorBox('gallery28');
deleteKolorBox('gallery29');
deleteKolorBox('gallery30');
deleteKolorBox('gallery31');
deleteKolorBox('gallery32');
deleteKolorBox('gallery33');
deleteKolorBox('gallery34');
deleteKolorBox('gallery35');
...
function eventTourChangeLanguage (pLang) {
	...
	ktools.I18N.getInstance().initLanguage(pLang, crossDomainTargetUrl+'TFE-2021data/TFE-2021_messages_','.xml');
}
...
function addKolorBox(pPlugID)
{
	...
	{
		var kolorBoxCSS = new ktools.CssStyle("KolorBoxCSS", crossDomainTargetUrl+"TFE-2021data/graphics/KolorBox/kolorBox.css");
		var kolorBoxJS = new ktools.Script("KolorBoxJS", crossDomainTargetUrl+"TFE-2021data/graphics/KolorBox/KolorBox.min.js", [], true);
